...
import org.haidash.visual.aco.algorithm.model.*;
...
public class Ant {
    ...
    private final SimpleObjectProperty<Pair>[][] localPheromones;
    ...
    public Ant(final Set<List<Integer>> badPaths,
               ...
               final SimpleObjectProperty[][] localPheromones) {
    ...
    private double getTau(final int x, final int y) {
        final Pair<Double, Double> pair = localPheromones[x][y].getValue();
    ...
    public void updatePheromones(final SimpleObjectProperty<Pair>[][] globalPheromones) {
        final AcoProperties properties = AcoProperties.getInstance();
        ...
        for (int i = 1; i < visited.size(); i++) {
            ...
            final Pair<Double, Double> pairPheromones = globalPheromones[first][second].getValue();
            ...
            globalPheromones[first][second].setValue(new Pair<>(pValue, nValue));
